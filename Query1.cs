...
namespace WeatherForecast
{
    public partial class Query1 : Form
    {
        ...
        {
            string query =
               "SELECT Sinoptik.Date_of_forecast FROM Forecast INNER JOIN Sinoptik ON Forecast.Forecast_number = Sinoptik.Forecast_number WHERE (((Forecast.Min_temp)>0)) ORDER BY Sinoptik.Date_of_forecast;";
